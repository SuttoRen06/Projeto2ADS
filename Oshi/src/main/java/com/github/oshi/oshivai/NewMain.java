...
//        System.out.println(hal.getProcessor()+ " CPU(s):");
//        System.out.println("Memory: " +
//        FormatUtil.formatBytes(hal.getMemory().getAvailable()) + "/" +
//        FormatUtil.formatBytes(hal.getMemory().getTotal()));
//        CentralProcessor cpuzada = si.getSystemCpuLoad();
//}   
//} 
...
public class NewMain {
    ...
    public static  void main(String[] args) {
        ...
        LOG.info("Checando nome usuario");
        mostrarNome();  
        
                
    }
    
    public static void getUserName(OSUser os){
        System.out.println("nome maquina" + os.getUserName());
    }    
    ...
    private static void mostrarNome (){
       System.out.println("NOME DO USUARIO MAQUINA: ");
       System.out.println(usuario_sessao); 
    }
